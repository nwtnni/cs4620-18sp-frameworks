...
public class Colord extends Vector3d {
	...
	public static final Colord BLACK = new Colord(0.0, 0.0, 0.0);
	public static final Colord WHITE = new Colord(1.0, 1.0, 1.0);
	...
	/**
	 * helper function for sRGB transform
	 * @param val: value of linear R/G/B value 
	 * */
	public double sRGB_helper(double val)
	{
		double a = 0.055;
		double ret;
		if (val <= 0.0031308)
		...
		{
			ret = (1.0 + a) * Math.pow(val, 1.0 / 2.4) - a;
		}
		return ret;
	}
