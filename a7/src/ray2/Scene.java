...
public class Scene {
	...
	/** The list of bsdfs in the scene. */
	protected ArrayList<BSDF> bsdfs = new ArrayList<BSDF>();
	public void addBSDF(BSDF toAdd) { bsdfs.add(toAdd); }
	public List<BSDF> getBSDFs() { return this.bsdfs; }
	...
	/** Environment that illuminates the scene from outside. **/
	protected Environment envMap;
	public Environment getEnvironment() { return this.envMap; }
	public void setEnvironment(Environment envMap) { this.envMap = envMap; }
	...
	/** The integrator **/
	protected Integrator integrator = Integrator.DEFAULT_INTEGRATOR;
