...
/**
 * A class that encapsulates the logic for selecting blocks of the image from a grid 
 * in a spiral pattern moving outward from the center.  This provides a rendering order
 * that tends to show the important content first, which is helpful for iterating on
 * changes to input scenes or to the code.
 */
